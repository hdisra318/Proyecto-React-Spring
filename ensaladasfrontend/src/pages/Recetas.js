        ...
        <>
            ...
            <main className="pt-4 pb-4">
                ...
                <div className="d-flex bg-dark justify-content-center bg-gradient m-5 rounded p-5">
                    <div className="boton-menu boton-menu-1 m-4 me-5 rounded">
                        <Link to="/recetas/receta1" className="text-white btn">Receta 1</Link>
                    </div>
                    <div className="boton-menu boton-menu-3 m-4 me-5 rounded">
                        <Link to="/recetas/receta2" className="text-white btn">Receta 2</Link>
                    </div>
                    <div className="boton-menu boton-menu-2 m-4 rounded">
